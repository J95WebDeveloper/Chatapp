  ...
  return (
    <div className='bg flex justify-center items-center h-full'>
        <div className='grid gap-3 lg:gap-5'>
            <h1 className='flex text-3xl md:text-5xl lg:text-6xl font-bold items-center'> Welcome <img src={Chatbot} className='w-8 md:w-16 mx-4 md:mx-6' /> <span> {authUser.fullname} </span></h1>
